    ...
    <div className="mt-45 flex flex-col gap-10 w-full bg-black/50 px-10 py-10 justify-center items-center">
      ...
      <div className="flex gap-10 justify-center items-center w-1/2">
        <div>
          <p className="text-white text-center text-lg">
            ...
            vero temporibus sint iusto officia explicabo! Distinctio assumenda
            eius omnis cumque quae dolore accusamus aperiam sequi consequuntur
            sint? Architecto, quam? Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Soluta atque reprehenderit natus vel, voluptatum
            quidem illum repudiandae? Deserunt ratione, accusantium fugit atque
            iusto, possimus error voluptatibus placeat voluptate, odio magni.
          </p>
          <div className="flex justify-center items-center gap-5 mt-5">
            <svg
              ...
              viewBox="0 0 640 640"
              fill="currentColor"
              className="size-7 text-green-200"
            >
      ...
      <div className="flex flex-col gap-10 w-full bg-black/50">
        <div className="flex gap-10 mx-5 my-5">
          <div className="flex flex-col justify-center items-center bg-black hover:bg-black/60 hover:rounded-tl-full rounded-lg border-2 border-gray-500">
            <Image
              src="/user.jpeg"
              alt="About Responsable"
              width={200}
          ...
          <div className="flex flex-col justify-center items-center bg-black hover:bg-black/60 hover:rounded-tr-full rounded-lg border-2 border-gray-500">
            <Image
              src="/user.jpeg"
              alt="About Responsable"
              width={200}
          ...
          <div className="flex flex-col justify-center items-center bg-black hover:bg-black/60 hover:rounded-tr-full rounded-lg border-2 border-gray-500">
            ...
            <div className="flex gap-1">
              <svg
                ...
                viewBox="0 0 640 640"
                fill="currentColor"
                className="size-6 text-green-200 hover:cursor-pointer"
              >
                <path d="M576 320C576 178.6 461.4 64 320 64C178.6 64 64 178.6 64 320C64 440 146.7 540.8 258.2 568.5L258.2 398.2L205.4 398.2L205.4 320L258.2 320L258.2 286.3C258.2 199.2 297.6 158.8 383.2 158.8C399.4 158.8 427.4 162 438.9 165.2L438.9 236C432.9 235.4 422.4 235 409.3 235C367.3 235 351.1 250.9 351.1 292.2L351.1 320L434.7 320L420.3 398.2L351 398.2L351 574.1C477.8 558.8 576 450.9 576 320z" />
              </svg>
              <svg

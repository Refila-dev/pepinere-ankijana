  ...
  return (
    <div className="mt-45 flex flex-col gap-10 w-full bg-black/50 px-10 py-10 justify-center items-center">
      ...
      <div className="flex flex-col gap-10 w-full bg-black/50">
        <div className="w-full h-full flex flex-wrap items-center justify-center gap-10 p-5">
          <div className="flex flex-col justify-center items-center bg-black hover:bg-black/60 hover:rounded-tl-full rounded-lg border-2 border-gray-500 w-full sm:w-1/2 lg:w-1/3">
            <Image
              src="/user.jpeg"
              alt="About Responsable"
              width={200}

...
import AboutResponsable from '../components/ui/about-reponsable'

const AboutPage = () => {
  return (
      <div className="flex flex-col width-full bg-black/50 justify-center items-center gap-20">
        <div className="rounded-b-full rounded-t-full bg-black/40 mt-55">
          <div className="flex px-50 gap-20 ">
            ...
            <div className="flex flex-col justify-center items-center gap-10">
              ...
              <p className="w-250 text-white text-center text-lg">
                ...
                cupiditate facere, beatae assumenda enim aperiam nam laboriosam
                eum ad nemo voluptatum culpa similique placeat quae minus
                perspiciatis impedit suscipit. Est! Lorem ipsum dolor sit, amet
                consectetur adipisicing elit. Et tempore incidunt ipsum nemo
                totam inventore fuga velit! Eligendi fugiat vel eum rem. Saepe
                perspiciatis tenetur id nesciunt libero quam dolor.
              </p>
            </div>
            <div>
